...
public class SellingPointService {
    ...
    private static final Logger log = LoggerFactory.getLogger(SellingPointService.class);
    ...
    public SellingPointService(RedisTemplate<String, Object> redisTemplate) {
    ...
    /**
     * Limpia todo el caché de Redis (útil para testing).
     */
    @CacheEvict(value = "sellingPoint", allEntries = true)
    public void clear() {
        Set<String> keys = redisTemplate.keys(CACHE_KEY_PREFIX + "*");
